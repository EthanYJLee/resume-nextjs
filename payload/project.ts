  ...
  list: [
    {
      ...
      descriptions: [
        ...
        {
          content:
            '프로젝트, 계약, 비용, 매출, 정산 등 복잡한 시나리오에서의 데이터 무결성 및 정합성 확보',
        },
        {
          content: '설계서 검증, 단위/통합테스트, 추가 기능 개발, 안정화 작업',
        },
        { content: 'ERP, 그룹웨어, 전자서명 등 연동 인터페이스 개발' },
      ],
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            'Colab에서 베이스 모델을 1회 로드한 뒤 색상별 adaptor를 순차적으로 끼우고 결과를 반환하도록 구성',
        },
        // {
        //   content:
        //     'ngrok 경고/CORS로 결과 저장이 막히는 이슈를 서버 다운로드 프록시 (`/api/download_image`)로 해결해 저장/공유 흐름을 안정화하고, 히스토리로 재작업 비용을 줄임',
        // },
      ],
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            '임시저장/세션 저장/최종 조회 흐름을 구성하여 작성 중 이탈 및 오류 상황에서도 재작업 비용을 줄임',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      descriptions: [
        ...
        {
          content:
            '게시글/댓글/대댓글/좋아요/신고 스키마를 설계하고 ID/중복체크/등록 플로우를 구현해 데이터 정합성을 확보',
        },
        {
          content:
